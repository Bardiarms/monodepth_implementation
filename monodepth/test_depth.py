...
--list /Users/bardiarms/Documents/CS/University_Courses/UT/Thesis/monodepth_implementation/monodepth/data/lists/kitti_test.txt \
--ckpt /Users/bardiarms/Documents/CS/University_Courses/UT/Thesis/monodepth_implementation/monodepth/outputs/extended/train_with_12000_iters/ckpt_012000.pth \
--data_root /Users/bardiarms/Documents/CS/University_Courses/UT/Thesis/monodepth_implementation/monodepth/data/kitti_raw \
--out /Users/bardiarms/Documents/CS/University_Courses/UT/Thesis/monodepth_implementation/monodepth/outputs/test_results/extended/with_12000_iters \
--height 256 \
--width 512 \
--device cpu \
--print_freq 10
...
def main(args):
    ...
    for i, (l, r, bf, gt) in enumerate(samples):
        ...
        left_t = TF.to_tensor(left_img).unsqueeze(0).to(device)

        with torch.no_grad():
            disp = model(left_t)["disp_l_0"]
